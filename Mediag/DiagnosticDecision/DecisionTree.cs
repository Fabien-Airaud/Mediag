...
namespace Mediag.DiagnosticDecision
{
    class DecisionTree
    {
        ...
        public void ResetTrainToDefault() { Train = new List<IForDecisionTree>((IEnumerable<IForDecisionTree>)CsvManager.GetTrainDiagnosis()); }

        public void ResetTestToDefault() { Test = new List<IForDecisionTree>((IEnumerable<IForDecisionTree>)CsvManager.GetTestDiagnosis()); }
